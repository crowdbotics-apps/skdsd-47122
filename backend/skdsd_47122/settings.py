"""
Django settings for skdsd_47122 project.
...
WSGI_APPLICATION = 'skdsd_47122.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "skdsd_47122 API",
    "DESCRIPTION": "API documentation for skdsd_47122 App",
    "VERSION": "v1",
}
